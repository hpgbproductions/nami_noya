...
A simple alternative to the sum function which allows the addition of clamping limits. It does not suffer from the unresponsiveness near clamping limits of `clamp` and `sum`.
